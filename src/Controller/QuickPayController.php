...
use Drupal\uc_paypal\Plugin\Ubercart\PaymentMethod\QuickPayGateway;

/**
 * Returns responses for PayPal routes.
 */
class QuickPayController extends ControllerBase {
   ...
   */
  public function quickPayComplete(OrderInterface $uc_order) {
    ...
    if (!$method instanceof QuickPayGateway) {
      return $this->redirect('uc_cart.cart');
    }
